...
const ExplorePage = () => {
  ...
  const CATEGORIES = [
    ...
    t("explore.categories.stem"),
    t("explore.categories.humanities"),
    t("explore.categories.biology"),
    t("explore.categories.languages"),
    t("explore.categories.technology"),
    t("explore.categories.business"),
  ];
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {owned && (
                        <div className="flex items-center gap-1 text-green-600 text-xs font-medium">
                          <Check size={12} />
                          <span>
                            {t("explore.alreadyAdded", "Na sua conta")}
                          </span>
                        </div>
                      )}
                    </div>
