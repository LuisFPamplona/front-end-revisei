...
const Performance = () => {
  ...
  return (
    <div className="min-h-screen md:pl-64">
      <Header />
      <div className="flex flex-col gap-6 pb-24 md:p-10 md:pt-10 animate-in fade-in duration-500 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center gap-4 pt-7 pb-14 md:grid md:grid-cols-3">
                ...
                <div className="relative w-full flex items-center justify-center">
                  <svg className="w-44 h-44 transform -rotate-90">
                    ...
                    <circle
                      ...
                      strokeDashoffset={
                        471 -
                        (471 * findCompletionPercentage(s, allTopics)) / 100
                      }
                      strokeLinecap="round"
